...
export const lessonsSubtitle = "Únete a nuestras clases de inducción a la pesca deportiva.";

export const blogTitle = "Guía de Pesca";

export const blogSubtitle = "Te compartimos contenido útil de nuestros blogs de pesca favoritos.";
